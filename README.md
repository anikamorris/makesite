...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the Color library. The documentation is located at https://godoc.org/github.com/fatih/color. My goal is to use it to change the color of the terminal output.`
- [x] **Add, commit, and push to GitHub**.
